	...
	<div class="container-fluid">
		<div class="row">
			<div class="col" style="margin-top:10px;">
				...
				<span style="font-weight: bold;  font-size: 25px;">ABC
					MANAGEMENT System
...
<div class="table-responsive-sm">
		...
		<div class="margin">
			<button style="float: left; padding: 5px;" class="btn btn-danger "
				id="delete" name="delete">
				<img src="../../images/delete.png">
			</button>

			<button style="float: right; padding: 5px; margin-right: 5px;"
				class="btn btn-success " id="delete" name="delete">
				<img src="../../images/delete.png">
			</button>
			<button style="float: right; padding: 5px; margin-right: 5px;"
				class="btn btn-primary " id="add" name="add">
				<img src="../../images/delete.png">
			</button>
